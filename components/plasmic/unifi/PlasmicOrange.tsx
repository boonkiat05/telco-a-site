...
import sty from "./PlasmicOrange.module.css"; // plasmic-import: 065BO1JJJI1f/css
...
export type PlasmicOrange__VariantMembers = {
  color:
    | "neutral"
    | "muted"
    | "success"
...
export type PlasmicOrange__VariantsArgs = {
...
type VariantPropType = keyof PlasmicOrange__VariantsArgs;
export const PlasmicOrange__VariantProps = new Array<VariantPropType>(
  "color",
  "type",
  "size",
  "iconStart",
...
export type PlasmicOrange__ArgsType = {
  disabled?: boolean;
  submitsForm?: boolean;
  resetsForm?: boolean;
  ariaLabel?: string;
...
type ArgPropType = keyof PlasmicOrange__ArgsType;
export const PlasmicOrange__ArgProps = new Array<ArgPropType>(
  "disabled",
  "submitsForm",
  "resetsForm",
  "ariaLabel",
...
export type PlasmicOrange__OverridesType = {
...
export interface DefaultOrangeProps {
  disabled?: boolean;
  submitsForm?: boolean;
  resetsForm?: boolean;
  ariaLabel?: string;
...
function PlasmicOrange__RenderFunc(props: {
  variants: PlasmicOrange__VariantsArgs;
  args: PlasmicOrange__ArgsType;
  overrides: PlasmicOrange__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    <BaseButton
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootcolor_unnamedVariant2]: hasVariant(
            $state,
            "color",
            "unnamedVariant2"
          ),
          ...
          [sty.rootglobal_unnamedGlobalGroupOfVariants2_unnamedVariant_flatSide_bottom]:
            hasVariant($state, "flatSide", "bottom") &&
            hasVariant(
              globalVariants,
              "unnamedGlobalGroupOfVariants2",
              "unnamedVariant"
          ...
          [sty.rootsize_extraLarge_color_unnamedVariant]:
            hasVariant($state, "size", "extraLarge") &&
            hasVariant($state, "color", "unnamedVariant"),
          ...
          [sty.roottype_soft_color_neutral]:
            hasVariant($state, "color", "neutral") &&
            hasVariant($state, "type", "soft"),
          [sty.roottype_soft_color_neutral_size_extraLarge]:
            hasVariant($state, "color", "neutral") &&
            hasVariant($state, "type", "soft") &&
            hasVariant($state, "size", "extraLarge"),
    ...
    >
      {(
        ...
        <div
          ...
          className={classNames(projectcss.all, sty.softBackground, {
            ...
            [sty.softBackgroundtype_soft_color_neutral]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft")
          })}
        />
      ...
      <div
        ...
        className={classNames(projectcss.all, sty.interactionEffect, {
          ...
          [sty.interactionEffectcolor_success_type_bordered]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.interactionEffectcolor_unnamedVariant]: hasVariant(
            $state,
            "color",
            "unnamedVariant"
          ),
          ...
          [sty.interactionEffectglobal_unnamedGlobalGroupOfVariants2_unnamedVariant]:
            hasVariant(
              globalVariants,
              "unnamedGlobalGroupOfVariants2",
              "unnamedVariant"
          ...
          [sty.interactionEffectsize_extraLarge_color_unnamedVariant]:
            hasVariant($state, "size", "extraLarge") &&
            hasVariant($state, "color", "unnamedVariant"),
      ...
      <div
        data-plasmic-name={"\u53e6\u5916"}
        data-plasmic-override={overrides.另外}
        className={classNames(projectcss.all, sty.另外, {
          [sty.另外color_errorDestructive]: hasVariant(
            $state,
            "color",
            "errorDestructive"
          ),
          [sty.另外color_neutral]: hasVariant($state, "color", "neutral"),
          [sty.另外color_success_type_bordered]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.另外color_unnamedVariant]: hasVariant(
            $state,
            "color",
            "unnamedVariant"
          ),
          [sty.另外flatSide_bottom]: hasVariant($state, "flatSide", "bottom"),
          [sty.另外global_unnamedGlobalGroupOfVariants2_unnamedVariant]:
            hasVariant(
              globalVariants,
              "unnamedGlobalGroupOfVariants2",
              "unnamedVariant"
            ),
          [sty.另外global_unnamedGlobalGroupOfVariants2_unnamedVariant_flatSide_bottom]:
            hasVariant($state, "flatSide", "bottom") &&
            hasVariant(
              globalVariants,
              "unnamedGlobalGroupOfVariants2",
          ...
          [sty.另外roundedFull]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.另外size_extraLarge]: hasVariant($state, "size", "extraLarge"),
          [sty.另外size_extraLarge_color_unnamedVariant]:
            hasVariant($state, "size", "extraLarge") &&
            hasVariant($state, "color", "unnamedVariant"),
          [sty.另外size_extraSmall]: hasVariant($state, "size", "extraSmall"),
          [sty.另外size_large]: hasVariant($state, "size", "large"),
          [sty.另外size_small]: hasVariant($state, "size", "small"),
          [sty.另外type_bordered]: hasVariant($state, "type", "bordered"),
          [sty.另外type_soft_color_neutral]:
            hasVariant($state, "color", "neutral") &&
            hasVariant($state, "type", "soft"),
          [sty.另外type_soft_color_neutral_size_extraLarge]:
            hasVariant($state, "color", "neutral") &&
            hasVariant($state, "type", "soft") &&
            hasVariant($state, "size", "extraLarge")
        })}
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox___1B8Gm, {
            [sty.freeBoxcolor_neutral___1B8GmYvJqs]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxiconStart___1B8GmnyylG]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge___1B8GmacWhn]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large___1B8Gmxpwc7]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small___1B8GmjG2Ht]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered___1B8GmTt8ZT]: hasVariant(
              $state,
              "type",
              "bordered"
            ),
            [sty.freeBoxtype_soft_color_neutral___1B8GmSiPw5YvJqs]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__iOfZ5)}
                role={"img"}
              />
            ),
        ...
        {renderPlasmicSlot({
          ...
          className: classNames(sty.slotTargetLabel, {
            ...
            [sty.slotTargetLabelcolor_success_type_soft]:
              hasVariant($state, "color", "success") &&
              hasVariant($state, "type", "soft"),
            [sty.slotTargetLabelcolor_unnamedVariant]: hasVariant(
              $state,
              "color",
              "unnamedVariant"
            ),
            ...
            [sty.slotTargetLabelflatSide_bottom]: hasVariant(
              $state,
              "flatSide",
              "bottom"
            ),
            [sty.slotTargetLabelglobal_unnamedGlobalGroupOfVariants2_unnamedVariant]:
              hasVariant(
                globalVariants,
                "unnamedGlobalGroupOfVariants2",
                "unnamedVariant"
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__chnH, {
            [sty.freeBoxiconEnd__chnHZoi8B]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__chnHAcWhn]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__chnHXpwc7]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__chnHJG2Ht]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__jiqi)}
                role={"img"}
              />
            ),
...
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicOrange__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicOrange__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicOrange__ArgProps,
          internalVariantPropNames: PlasmicOrange__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicOrange__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicOrange";
  } else {
    func.displayName = `PlasmicOrange.${nodeName}`;
  }
  return func;
}

export const PlasmicOrange = Object.assign(
  // Top-level PlasmicOrange renders the root element
  makeNodeComponent("root"),
  {
    ...
    另外: makeNodeComponent("\u53e6\u5916"),

    // Metadata about props expected for PlasmicOrange
    internalVariantProps: PlasmicOrange__VariantProps,
    internalArgProps: PlasmicOrange__ArgProps
  }
);

export default PlasmicOrange;
/* prettier-ignore-end */
