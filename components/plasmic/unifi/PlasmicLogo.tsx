...
import sty from "./PlasmicLogo.module.css"; // plasmic-import: zUXUcRMuH6zq/css
    ...
    >
      <PlasmicImg__
        ...
        className={classNames(sty.img, {
          ...
          [sty.imgglobal_unnamedGlobalGroupOfVariants2_unnamedVariant]:
            hasVariant(
              globalVariants,
              "unnamedGlobalGroupOfVariants2",
              "unnamedVariant"
        ...
        src={
          hasVariant(globalVariants, "screen", "mobileOnly")
            ? {
                src: "/plasmic/unifi/images/logo1Png.png",
                fullWidth: 393,
                fullHeight: 70,
