...
import sty from "./PlasmicListItem.module.css"; // plasmic-import: sdfK96wbM7GJ/css

import CheckCircleIcon from "./icons/PlasmicIcon__CheckCircle"; // plasmic-import: SK3QgjQMnF9I/icon
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <CheckCircleIcon
            className={classNames(projectcss.all, sty.svg__ssPjf)}
            role={"img"}
          />
        ),
