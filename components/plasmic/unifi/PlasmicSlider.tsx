...
import SliderThumb from "../../SliderThumb"; // plasmic-import: _jVSQg-qMKkI/component
...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: G6oqnNLDCk9Z/css
  ...
  return (
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <div className={classNames(projectcss.all, sty.freeBox__p1ZVs)}>
          {$props.showLabel ? (
            <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__wBlK)}>
        <div
