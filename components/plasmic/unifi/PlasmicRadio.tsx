...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: yrntQ6y5GLv9/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__s2VD)}>
        <div className={classNames(projectcss.all, sty.freeBox__ce3R)} />
      </div>
      {renderPlasmicSlot({
