...
import Label from "../../Label"; // plasmic-import: fLtJ9E7qUmNC/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: 9PwqFeR-9J-E/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: mQkrtvDi894X/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__rybp, {
          [sty.freeBoxiconEnd__rybpC2NDr]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__rybpGtvDg]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__rybpHEpwj]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox___4UFfE, {
            [sty.freeBoxiconStart___4UFfEGtvDg]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine___4UFfEhEpwj]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__jeIi3)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__intV, {
            [sty.freeBoxiconEnd__intVC2NDr]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__intVGtvDg]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___2JAmW)}
                role={"img"}
              />
            ),
...
const PlasmicDescendants = {
  ariaTextField: ["ariaTextField", "label", "textAreaInput", "description"],
  label: ["label"],
