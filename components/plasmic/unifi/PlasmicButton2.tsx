...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: Ee_1C2OkYdIE/css
...
function PlasmicButton2__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__ryzBc, {
          [sty.freeBoxcolor_neutral__ryzBcB7Zdm]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__ryzBc9VvkpNnGue]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxcolor_white__ryzBczwmIz]: hasVariant(
            $state,
            "color",
            "white"
          ),
          [sty.freeBoxroundedFull__ryzBcRe0I6]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__ryzBcy3Xg3]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__ryzBcdSspP]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__ryzBczj5Xz]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__ryzBcSg9X]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__ryzBcNnGue]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__ahWQy, {
            [sty.freeBoxcolor_neutral__ahWQyB7Zdm]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxiconStart__ahWQyAdo0O]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__ahWQyy3Xg3]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__ahWQyzj5Xz]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__ahWQySg9X]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__ahWQyNnGue]: hasVariant(
              $state,
              "type",
              "bordered"
            ),
            [sty.freeBoxtype_soft_color_neutral__ahWQy5NylCB7Zdm]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___0IjKg)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__faHyl, {
            [sty.freeBoxiconEnd__faHylGW9H]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__faHyly3Xg3]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__faHylzj5Xz]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__faHylSg9X]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__npmqy)}
                role={"img"}
              />
            ),
