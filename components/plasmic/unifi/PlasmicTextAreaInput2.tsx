...
import sty from "./PlasmicTextAreaInput2.module.css"; // plasmic-import: o5uBIDbWxhu0/css

createPlasmicElementProxy;

export type PlasmicTextAreaInput2__VariantMembers = {
  type: "soft" | "plain";
  flat: "top" | "right" | "bottom" | "left";
  padded: "left" | "right";
};
export type PlasmicTextAreaInput2__VariantsArgs = {
  type?: SingleChoiceArg<"soft" | "plain">;
  flat?: MultiChoiceArg<"top" | "right" | "bottom" | "left">;
  padded?: MultiChoiceArg<"left" | "right">;
};
type VariantPropType = keyof PlasmicTextAreaInput2__VariantsArgs;
export const PlasmicTextAreaInput2__VariantProps = new Array<VariantPropType>(
  "type",
  "flat",
  "padded"
);

export type PlasmicTextAreaInput2__ArgsType = {
  placeholder?: string;
  defaultValue?: string;
  disabled?: boolean;
  readOnly?: boolean;
...
type ArgPropType = keyof PlasmicTextAreaInput2__ArgsType;
export const PlasmicTextAreaInput2__ArgProps = new Array<ArgPropType>(
  "placeholder",
  "defaultValue",
  "disabled",
  "readOnly",
...
export type PlasmicTextAreaInput2__OverridesType = {
  ariaTextArea?: Flex__<typeof BaseTextArea>;
};

export interface DefaultTextAreaInput2Props {
  placeholder?: string;
  defaultValue?: string;
  disabled?: boolean;
  readOnly?: boolean;
...
function PlasmicTextAreaInput2__RenderFunc(props: {
  variants: PlasmicTextAreaInput2__VariantsArgs;
  args: PlasmicTextAreaInput2__ArgsType;
  overrides: PlasmicTextAreaInput2__OverridesType;
  forNode?: string;
}) {
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicTextAreaInput2__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicTextAreaInput2__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicTextAreaInput2__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicTextAreaInput2__ArgProps,
          internalVariantPropNames: PlasmicTextAreaInput2__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicTextAreaInput2__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "ariaTextArea") {
    func.displayName = "PlasmicTextAreaInput2";
  } else {
    func.displayName = `PlasmicTextAreaInput2.${nodeName}`;
  }
  return func;
}

export const PlasmicTextAreaInput2 = Object.assign(
  // Top-level PlasmicTextAreaInput2 renders the root element
  makeNodeComponent("ariaTextArea"),
  {
    // Helper components rendering sub-elements

    // Metadata about props expected for PlasmicTextAreaInput2
    internalVariantProps: PlasmicTextAreaInput2__VariantProps,
    internalArgProps: PlasmicTextAreaInput2__ArgProps
  }
);

export default PlasmicTextAreaInput2;
/* prettier-ignore-end */
