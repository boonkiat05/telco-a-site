...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: tn0m7BktVF7t/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__hFh2)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox___7MuKs)}>
            <div
              className={classNames(
                projectcss.all,
