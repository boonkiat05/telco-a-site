...
import Radio from "../../Radio"; // plasmic-import: yrntQ6y5GLv9/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: lhD3uLBTxK7T/css
...
function PlasmicRadioGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox___16Nl6)}>
            <Radio
              className={classNames("__wab_instance", sty.radio__ceD3Q)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__vXIq)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__a72Ap)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
...
const PlasmicDescendants = {
  ariaRadioGroup: ["ariaRadioGroup", "description"],
